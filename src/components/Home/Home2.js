          ...
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <i>
                ...
                and the ways in which they can enhance the user experience.
                Additionally, I am passionate about exploring {"  "}
                <b className="purple">
                    <i>
                    Interaction Design and Human Computer Interaction &nbsp;
                    </i>
                </b>
                and how these fields can be used to create more accessible, 
        ...
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/shreyas-kasetty-66802a176/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
